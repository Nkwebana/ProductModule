...
function ProductModule({ navigation, products, addToCart, componentId }) {
...
ProductModule.defaultProps = {
  products: [
    ...
    },
    {
      ...
      productPrice: 80,
      productImage:
        "https://www.verywellhealth.com/thmb/-EP3Xy46uvfaoGcXo8f-froqabY=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-1167159966-ede3f881729e4b53b0508aa1a801b227.jpg",
      productSize: "500ml",
      productDescription: "This is coolest product ever.",
    },
  ],
